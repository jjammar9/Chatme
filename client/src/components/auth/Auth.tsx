  ...
  return (
    <div className="min-h-screen bg-off-white flex items-center justify-center px-6">
      <div className="w-full max-w-xs flex flex-col items-center">
        <div className="w-fit bg-dark-purple rounded-2xl rounded-br-none p-3 shadow-lg mb-8">
        ...
        <h1 className="text-3xl font-bold text-dark-purple tracking-tight mb-1">
          {mode === "login" ? "Sign in to Chatme" : "Join Chatme"}
        </h1>
        <p className="text-sm text-dark-purple/50 mb-8">
          {mode === "login" ? "Stay connected with your team." : "Create your account to get started."}
        </p>
        ...
        <p className="text-sm text-dark-purple/50 mt-8">
          {mode === "login" ? (

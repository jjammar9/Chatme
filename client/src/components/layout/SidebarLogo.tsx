export default function SidebarLogo({ onClick }: { onClick: () => void }) {
  return (
    <button onClick={onClick} className="pl-7 pr-6 py-6 hover:opacity-80 transition-opacity text-left">
      <div className="w-fit bg-off-white rounded-xl rounded-br-none p-2">
